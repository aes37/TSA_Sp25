...
raw_inflow_data <- read.table(file="/Users/aes/Desktop/time-series-analysis/Data/inflowtimeseries.txt",header=FALSE,skip=0)
...
```{r}
ts_inflow_data <- ts(inflow_data[,2:4], start=c(1931,1), frequency=12) # monthly data set
ts_inflow_data
